...
if model_selection == 'model_91':
    model_path = os.path.join(BASE_DIR, "models", "model_91.h5")
elif model_selection == 'model_169':
    model_path = os.path.join(BASE_DIR, "models", "model_169.h5")
elif model_selection == 'model_187':
    model_path = os.path.join(BASE_DIR, "models", "model_187.h5")
