...
scaler = pickle.load(open('./Experiment/objects/scaler.pkl', 'rb'))
model = pickle.load(open('./Experiment/objects/models/model_no_2.pkl', 'rb'))
...
image_folder = './Experiment/images'  # Path to your images folder
